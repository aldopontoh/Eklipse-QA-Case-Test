...
WebUI.verifyElementPresent(findTestObject('Convert To TikTok Features/Page_Eklipse/button_Convert Clip to Vertical'), 0)

WebUI.click(findTestObject('Convert To TikTok Features/Page_Eklipse/button_Convert Clip to Vertical'), FailureHandling.OPTIONAL)

WebUI.switchToWindowIndex(1)

WebUI.verifyElementPresent(findTestObject('Convert To TikTok Features/Page_Eklipse studio/txt_Add Clip to Start'), 0)
