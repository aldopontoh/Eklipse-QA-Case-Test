...
WebUI.click(findTestObject('Account Setting/Page_Eklipse/icon_user'))

WebUI.click(findTestObject('Account Setting/Page_Eklipse/button_Account Settings'))

WebUI.verifyElementPresent(findTestObject('Account Setting/Page_Eklipse/btn_Personal Details'), 0)

WebUI.verifyElementPresent(findTestObject('Account Setting/Page_Eklipse/btn_Plugin Setting'), 0)

WebUI.verifyElementPresent(findTestObject('Account Setting/Page_Eklipse/btn_Premium Plan'), 0)

WebUI.verifyElementPresent(findTestObject('Account Setting/Page_Eklipse/btn_Game Setting'), 0)
