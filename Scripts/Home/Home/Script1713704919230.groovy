...
WebUI.click(findTestObject('Home/Page_Eklipse/btn_YouTube Highlights'))

WebUI.verifyElementPresent(findTestObject('Home/Page_Eklipse/txt_Clip a YouTube Video'), 0)

WebUI.verifyElementPresent(findTestObject('Home/Page_Eklipse/txtField_input_url'), 0)

WebUI.verifyElementPresent(findTestObject('Home/Page_Eklipse/button_Get Clip'), 0)

WebUI.verifyElementPresent(findTestObject('Home/Page_Eklipse/button_Upload'), 0)
